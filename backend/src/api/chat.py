...
from src.services.chat.schema import Message, MessageOut, Chat, ChatOut, ReadMessage
...
async def read_message(message: ReadMessage):
    return await ChatService(settings.chart_service_url).read(message)
